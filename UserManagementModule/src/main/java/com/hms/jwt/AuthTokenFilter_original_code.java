...
@Component
public class AuthTokenFilter_original_code extends OncePerRequestFilter {
    @Autowired
    ...
    public AuthTokenFilter_original_code() {}
...
//	}
    ...
    private static final Logger logger = LoggerFactory.getLogger(AuthTokenFilter_original_code.class);
